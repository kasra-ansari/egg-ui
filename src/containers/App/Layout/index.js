...
const Layout = props => (
    ...
    <div class="wsmenucontent overlapblackbg"></div>
		<div class="wsmenuexpandermain slideRight">
			...
			<a href="#" class="smallogo"><img src="images/logo.png.html" width="120" alt="" /></a>
		</div>
			...
			<div class="nav-wrapper">
				<div class="container">
					<nav class="wsmenu slideLeft clearfix">
						<div class="logo pull-left"><a href="index.html" title="Responsive Slide Menus"><img src="images/logo.png.html" alt="" /></a></div>
